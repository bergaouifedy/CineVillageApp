...
@Database(entities = {AnnonceModel.class,UserModel.class, SignalsModel.class, ReservationModel.class, LocalisationModel.class},version = 1)
@TypeConverters({ReservationModel.Converters.class})
